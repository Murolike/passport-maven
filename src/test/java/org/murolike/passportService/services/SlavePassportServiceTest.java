...
class SlavePassportServiceTest {
    ...
    private List<SlavePassport> passportList;
    ...
    void findAll() throws Exception {
        ...
        mvc.perform(get("/v1/slave-passport/index").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
    ...
    void findAllBySeriesAndNumber() throws Exception {
        ...
        mvc.perform(get("/v1/slave-passport/search/" + passport.getSeries() + "/" + passport.getNumber()).contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$", Matchers.hasSize(1)))
                .andExpect(jsonPath("$[0].series", Matchers.is(passport.getSeries())))
                .andExpect(jsonPath("$[0].number", Matchers.is(passport.getNumber())));
